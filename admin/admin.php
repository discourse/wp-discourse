...
class DiscourseAdmin {
	...
	protected $publish_settings;
	protected $comment_settings;
	protected $configurable_text_settings;
	protected $sso_settings;
	...
	public function __construct() {
		...
		$this->connection_settings = new \WPDiscourse\ConnectionSettings\ConnectionSettings( $this->option_input );
		$this->publish_settings = new \WPDiscourse\PublishSettings\PublishSettings( $this->option_input );
		$this->comment_settings = new \WPDiscourse\CommentSettings\CommentSettings( $this->option_input );
		$this->configurable_text_settings = new \WPDiscourse\ConfigurableTextSettings\ConfigurableTextSettings( $this->option_input );
		$this->sso_settings = new \WPDiscourse\SSOSettings\SSOSettings( $this->option_input );
