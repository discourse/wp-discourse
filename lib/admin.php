...
//		add_action( 'load-' . $sso, array( $this, 'establish_connection_notice' ) );
	...
	function sso_settings_display() {
		?>
		<p class="documentation-link">
			<em><?php esc_html_e( 'This section is for configuring WordPress as the Sign On provider for Discourse. Unless you have a need to manage your forum\'s users '.
			                      'through your WordPress site, you can leave this setting alone. For more information see  ', 'wp-discourse' ); ?></em>
			<a href="https://github.com/discourse/wp-discourse/wiki/Setup">https://github.com/discourse/wp-discourse/wiki/Setup</a>
		</p>
		<?php
	}
