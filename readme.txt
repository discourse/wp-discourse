...
- Cache all comment HTML that is generated by the plugin
- Check for a unique nonce in Rest Route permission callbacks
- Improve sanitization of data returned from API requests to Discourse
