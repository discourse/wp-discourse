 ...
 */
abstract class AbstractHandler implements \WPDiscourse\Monolog\Handler\HandlerInterface, \WPDiscourse\Monolog\ResettableInterface
{
    protected $level = \WPDiscourse\Monolog\Logger::DEBUG;
