 ...
 */
class BrowserConsoleHandler extends \WPDiscourse\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \WPDiscourse\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
