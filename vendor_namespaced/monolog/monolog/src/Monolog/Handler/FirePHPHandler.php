...
use WPDiscourse\Monolog\Formatter\WildfireFormatter;
/**
 * Simple FirePHP Handler (http://www.firephp.org/), which uses the Wildfire protocol.
 *
 * @author Eric Clemmons (@ericclemmons) <eric@uxdriven.com>
 */
class FirePHPHandler extends \WPDiscourse\Monolog\Handler\AbstractProcessingHandler
{
    /**
    ...
    {
        return new \WPDiscourse\Monolog\Formatter\WildfireFormatter();
    }
    /**
