 ...
 */
class PushoverHandler extends \WPDiscourse\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct($token, $users, $title = null, $level = \WPDiscourse\Monolog\Logger::CRITICAL, $bubble = \true, $useSSL = \true, $highPriorityLevel = \WPDiscourse\Monolog\Logger::CRITICAL, $emergencyLevel = \WPDiscourse\Monolog\Logger::EMERGENCY, $retry = 30, $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \WPDiscourse\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \WPDiscourse\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
