 ...
 */
class RedisHandler extends \WPDiscourse\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $redisKey;
    protected $capSize;
     ...
     */
    public function __construct($redis, $key, $level = \WPDiscourse\Monolog\Logger::DEBUG, $bubble = \true, $capSize = \false)
    {
        if (!($redis instanceof \WPDiscourse\Predis\Client || $redis instanceof \Redis)) {
