 ...
 */
class RotatingFileHandler extends \WPDiscourse\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct($filename, $maxFiles = 0, $level = \WPDiscourse\Monolog\Logger::DEBUG, $bubble = \true, $filePermission = null, $useLocking = \false)
    {
        $this->filename = \WPDiscourse\Monolog\Utils::canonicalizePath($filename);
