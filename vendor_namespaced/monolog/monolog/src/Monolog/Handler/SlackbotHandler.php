 ...
 */
class SlackbotHandler extends \WPDiscourse\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \WPDiscourse\Monolog\Logger::CRITICAL, $bubble = \true)
    {
