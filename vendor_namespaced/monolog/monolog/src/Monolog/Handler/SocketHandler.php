 ...
 */
class SocketHandler extends \WPDiscourse\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($connectionString, $level = \WPDiscourse\Monolog\Logger::DEBUG, $bubble = \true)
    {
