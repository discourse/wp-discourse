 ...
 */
class IntrospectionProcessor implements \WPDiscourse\Monolog\Processor\ProcessorInterface
{
    private $level;
    private $skipClassesPartials;
    private $skipStackFramesCount;
    private $skipFunctions = array('call_user_func', 'call_user_func_array');
    public function __construct($level = \WPDiscourse\Monolog\Logger::DEBUG, array $skipClassesPartials = array(), $skipStackFramesCount = 0)
    {
