...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \WPDiscourse\Psr\Log\LogLevel::CRITICAL, $callPrevious = \true, $restartSyscalls = \true, $async = \true)
    {
    ...
    public function handleSignal($signo, array $siginfo = null)
    {
        ...
        $level = isset($this->signalLevelMap[$signo]) ? $this->signalLevelMap[$signo] : \WPDiscourse\Psr\Log\LogLevel::CRITICAL;
