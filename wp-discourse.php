...
define( 'WPDISCOURSE_VERSION', '1.7.7' );
...
require_once __DIR__ . '/lib/discourse-topic-map-formatter.php';
...
$discourse_topic_map_formatter =  new WPDiscourse\DiscourseTopicMapFormatter\DiscourseTopicMapFormatter();
new WPDiscourse\DiscourseComment\DiscourseComment( $discourse_comment_formatter, $discourse_topic_map_formatter );
